	...
	if(ls_atl.qual)then
		...
		if(status == 3)then				
	 	if(ls_atl.qual.item)then
	 	 if(atl_para_container(mouse.esq,ls_inv))atl_on_off(true)
			else
...
function atl_para_container(context,qual_container)
	...
	if(context)then
		...
		if(not qual_container.qual)then
  ...
  --se algo do container
		...
		--o item do atalho
			...
			container_para_atl(true,qual_container)
		end
...
function funcionalidades()
	...
	--tem um item?
	if(ls_atl.qual.item)then
		cu1 = "eu tenho item porra"
	--nao tem?
 else
		cu1 = "sou incopetente"
 	container_para_atl(mouse.esq,ls_jrd)
 end

--[[
if(range(que_item.tip,5,8) or )then
...

